...
int main () {
    ...
    auto pixel_delta_u = viewport_u / image_width; // x axis
    auto pixel_delta_v = viewport_v / image_height; // y axis
    ...
    for (int j = 0; j < image_height; j++) {
        ...
        for (int i = 0; i < image_width; i++) {
            ...
            auto ray_direction = pixel_center - camera_center; // The - op does nothing
